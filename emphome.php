...
<body>
    ...
    <?php
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="updateprojs.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="project_status" name="new_status" required>
                    </div>
                    <div class="form-group">
                        <label for="project_description">Project Description</label>
                        <textarea class="form-control" id="project_description" name="comments" rows="3" required></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary" name="updateprojs">Update Project</button>
                </form>
            </div>
        </div>
    </div>
